...
$sys_name = get_setting('system_name', 'Concentrix Gatepass');
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
        ...
        <div class="md:col-span-4 space-y-3 sticky top-24">
            <a href="#system-config" class="block p-4 rounded-2xl bg-slate-800/40 border border-slate-700/60 hover:bg-slate-800 text-sm font-semibold text-slate-200 hover:text-white transition-all flex items-center gap-3">
                <i class="fa-solid fa-sliders text-brand-teal text-base"></i>
            ...
            <a href="#smtp-settings" class="block p-4 rounded-2xl bg-slate-800/40 border border-slate-700/60 hover:bg-slate-800 text-sm font-semibold text-slate-200 hover:text-white transition-all flex items-center gap-3">
                <i class="fa-solid fa-envelope-open-text text-brand-teal text-base"></i>
            ...
            <a href="#admin-profile" class="block p-4 rounded-2xl bg-slate-800/40 border border-slate-700/60 hover:bg-slate-800 text-sm font-semibold text-slate-200 hover:text-white transition-all flex items-center gap-3">
                <i class="fa-solid fa-user-gear text-brand-teal text-base"></i>
        ...
        <div class="md:col-span-8 space-y-8">
            ...
            <div id="system-config" class="glass-card p-6 sm:p-8 rounded-3xl border border-slate-800 shadow-2xl relative overflow-hidden">
                <div class="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-brand-blue to-brand-teal"></div>
                <h3 class="text-lg font-black text-white mb-6 flex items-center gap-2">
                    <i class="fa-solid fa-sliders text-brand-teal"></i> General Configurations
                </h3>
                ...
                <form action="settings.php#system-config" method="POST" class="space-y-4">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input type="text" name="system_name" required value="<?php echo htmlspecialchars($sys_name); ?>"
                                   class="w-full px-4 py-2.5 bg-dark-900 border border-slate-800 focus:border-brand-teal focus:ring-brand-teal rounded-xl text-white placeholder-slate-500 text-sm focus:outline-none focus:ring-1 transition-all">
                        </div>
                        ...
                        <div class="space-y-1.5">
                            ...
                            <span class="block text-[10px] text-slate-500 mt-1">
                                Suggested local network IP: <strong class="text-brand-teal select-all"><?php echo $server_detected_ip; ?></strong>
                            </span>
                        </div>
                    ...
                    <div class="pt-4 border-t border-slate-800/80 text-right">
                        <button type="submit" name="update_settings"
                                class="px-5 py-2.5 bg-brand-teal hover:bg-[#1fd4be] text-dark-900 font-bold text-xs rounded-xl shadow-lg transition-all">
            ...
            <div id="smtp-settings" class="glass-card p-6 sm:p-8 rounded-3xl border border-slate-800 shadow-2xl relative overflow-hidden">
                <div class="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-brand-blue to-brand-teal"></div>
                <h3 class="text-lg font-black text-white mb-6 flex items-center gap-2">
                    <i class="fa-solid fa-envelope-open-text text-brand-teal"></i> SMTP Mail Server Settings
                </h3>

                <!-- Gmail setup instructions helper block -->
                <div class="mb-6 p-4 rounded-2xl bg-brand-blue/20 border border-brand-teal/20 text-slate-300 text-xs space-y-2">
                    <h4 class="font-bold text-brand-teal flex items-center gap-1.5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input type="text" name="smtp_host" value="<?php echo htmlspecialchars($s_host); ?>"
                                   class="w-full px-4 py-2.5 bg-dark-900 border border-slate-800 focus:border-brand-teal focus:ring-brand-teal rounded-xl text-white text-sm focus:outline-none focus:ring-1 transition-all">
                        </div>
                        ...
                        <div class="space-y-1.5">
                            ...
                            <select name="smtp_secure" class="w-full px-4 py-2.5 bg-dark-900 border border-slate-800 focus:border-brand-teal focus:ring-brand-teal rounded-xl text-white text-sm focus:outline-none focus:ring-1 transition-all cursor-pointer">
            ...
            <div id="admin-profile" class="glass-card p-6 sm:p-8 rounded-3xl border border-slate-800 shadow-2xl relative overflow-hidden">
                <div class="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-brand-blue to-brand-teal"></div>
                <h3 class="text-lg font-black text-white mb-6 flex items-center gap-2">
                    <i class="fa-solid fa-user-gear text-brand-teal"></i> Admin Profile Security
                </h3>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-1.5 sm:col-span-2 pt-2 border-t border-slate-800/80">
                            ...
                            <input type="password" name="current_password" required placeholder="Enter current password to save changes"
                                   class="w-full px-4 py-2.5 bg-dark-900 border border-rose-900/30 focus:border-brand-teal focus:ring-brand-teal rounded-xl text-white text-sm focus:outline-none focus:ring-1 transition-all">
                        </div>
                    </div>
