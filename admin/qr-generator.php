...
<div class="max-w-xl mx-auto py-4 text-center">
    ...
    <div class="glass-card p-10 rounded-3xl border border-slate-800 shadow-2xl relative overflow-hidden mb-6 flex flex-col items-center" id="qr-poster">
        ...
        <div class="w-16 h-16 rounded-2xl bg-indigo-500/15 border border-indigo-500/35 flex items-center justify-center text-indigo-400 text-3xl mb-6">
        ...
        <p class="text-indigo-400 font-extrabold text-xs uppercase tracking-widest mb-6">Lobby Registration Terminal</p>
        ...
        <div class="mt-8 pt-6 border-t border-dashed border-slate-800/80 w-full">
            ...
            <span class="text-xs text-indigo-400 font-bold select-all break-all"><?php echo htmlspecialchars($register_url); ?></span>
        </div>
    </div>
    ...
    <div class="no-print">
        <button onclick="window.print()"
                class="px-6 py-3 bg-indigo-600 hover:bg-indigo-500 active:scale-95 transition-all text-white font-bold text-sm rounded-xl shadow-lg shadow-indigo-600/10 inline-flex items-center space-x-2">
