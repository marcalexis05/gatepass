...
<div class="max-w-md mx-auto py-8">
    <div class="text-center mb-8">
        <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-brand-teal/10 border border-brand-teal/20 text-brand-teal text-3xl mb-4 shadow-lg shadow-indigo-500/5">
    ...
    <!-- Login Card -->
    <div class="glass-card p-8 rounded-3xl border border-dark-800 shadow-2xl relative overflow-hidden">
        ...
        <form action="login.php<?php echo $redirect ? '?redirect=' . urlencode($redirect) : ''; ?>" method="POST" class="space-y-5">
            ...
            <div class="pt-2">
                <button type="submit"
                        class="w-full py-3 bg-brand-teal hover:bg-[#1fd4be] active:scale-[0.99] text-dark-900 font-bold text-sm rounded-xl shadow-lg shadow-brand-teal/10 flex items-center justify-center space-x-2 transition-all">
